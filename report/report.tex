...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=.75]{auc-window-1.png}
...
\begin{figure}[!htbp]
  ...
  \end{subfigure}%
  \begin{subfigure}{.5\textwidth}
    \includegraphics{ecdf-regression3-d-non_forest-1.png}
    \caption{Non-forest}
