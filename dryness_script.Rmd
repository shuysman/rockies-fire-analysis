...
```{r forest_roc, fig.width = 8, fig.height = 8, include = TRUE, eval = T, message = F, echo = F}
## library(lme4)
...
```{r nonforest_roc, fig.width = 8, fig.height = 8, eval = T, message = F, echo = F}
...
# Questions
## Modeling
- are we violating indepdencence assumption for logistic regression?
- should we be using test data set to fit models?
