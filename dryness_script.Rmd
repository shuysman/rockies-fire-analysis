...
ecoregion <- ecoregions %>% filter(US_L3NAME == "Southern Rockies")
...
# ROC Analysis
```{r forest_roc, include = TRUE, eval = T, message = F, echo = F}
...
```{r nonforest_roc, eval = T, message = F, echo = F}
...
```{r wb-vs-area, fig.width = 8, echo = F, message = F}
...
```{r wb-vs-logarea, fig.width = 8, echo = F, message = F}
